...
<div class="flex flex-row w-full justify-center lg:mt-4">
   <div in:fly={flyin} class="w-full lg:w-1/2 h-auto bg-gray-100 dark:bg-slate-800 p-1 lg:p-2 lg:rounded-lg drop-shadow-xl" style="background-color: {background};">
